use binance_core_data_integration::{ImsBinanceDataIntegration, COIN_M_API_BASE_URL, COIN_M_API_WSS_URL, COIN_M_TESTNET_API_BASE_URL, COIN_M_TESTNET_API_WSS_URL};
use binance_data_integration_macro::{ BinanceImsOhlcvDataIntegration, BinanceImsSymbolIntegration, BinanceImsTradeDataIntegration};
...
impl ImsBinanceCoinFuturesDataIntegration {
    ...
    pub fn testnet() -> Self {
        Self {
            integration: ImsBinanceDataIntegration::new(COIN_M_TESTNET_API_BASE_URL, COIN_M_TESTNET_API_WSS_URL),
        }
    }
}
